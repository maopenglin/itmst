...
public class TestResume extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("<HTML>");
		out.println("<HEAD><TITLE>打包服务器自动化测试版</TITLE></HEAD>");
		out.println("<BODY>");
	         		  ...
	         		  for(int s=0;s<ta.length;s++){
	         			 //out.println("tas  \n"+ta[s].getAbsolutePath());
	 	         		 ...
	 	         		 // for(int y=0;y<bf.length;y++){
	 	         			 String execPath=ta[s].getAbsolutePath()+"/test.bin";
	 	         			...
	 	         			if(efile.exists()){
	 	         			 ...
	 	         			 // if(ta[s].isFile()&&ta[s].getName().equals("ios.bin")){
	 	                             ...
	 	                             String cmd = "rm -rf "+execPath.replace("test.bin", "")+cat.downloadPath+"/*";
